    ...
    <>
      ...
      {showContent && (
        <div className="main w-full">
          ...
          {/* Blue Section Fix */}
          <div className="w-full min-h-screen flex items-center justify-center bg-blue-900 text-white px-10 py-20">
            <div className="cntnr flex w-full max-w-[1400px] flex-wrap gap-10 justify-between">
              <div className="limg relative w-full md:w-1/2 flex justify-center items-center">
                <img
                  className="scale-[1.3] max-h-[500px] object-contain"
                  src="./imag.png"
                  alt=""
                />
              </div>
              <div className="rg w-full md:w-[40%]">
                <h1 className="text-6xl md:text-8xl mb-4">Still Running,</h1>
                <h1 className="text-6xl md:text-8xl mb-6">Not Hunting</h1>
                <p className="mb-4 text-xl font-[Helvetica_Now_Display]">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Distinctio possimus,
                  asperiores nam, omnis inventore nesciunt a architecto eveniet saepe.
                </p>
                <p className="mb-4 text-xl font-[Helvetica_Now_Display]">
                ...
                <p className="mb-6 text-xl font-[Helvetica_Now_Display]">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. At eius illum fugit
                  eligendi nesciunt quia similique velit excepturi soluta tenetur illo.
                </p>
